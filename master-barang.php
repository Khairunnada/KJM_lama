...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <a style="color:black;" href="?id_nav_detail=<?php echo $id_nav_detail; ?>&refresh&daftar">Barang</a>
    </h1>
    <ol class="breadcrumb">
      <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="barang.php?id_nav=<?php echo $id_nav; ?>"><?php echo $nav; ?></a></li>
      <li><a href="?id_nav_detail=<?php echo $id_nav_detail; ?>&refresh&daftar">Barang</a></li>
    </ol>
  </section>
  <?php
//PAGE_DAFTAR
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-success" style="padding:5px;">
              ...
              <div style="color:white;">Berhasil Menambah Barang Baru</div>
            </div>
            <?php
            }
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select id="golongan" name="golongan" class="form-control select2" style="width: 100%;" required>
                      <option value="">Pilih..</option>
                      <?php
                      $sql =
                      "SELECT
                      ...
                      WHERE
                        a.aktif = 1";
                      $sql .= " ORDER BY a.golongan "; echo $sql;
                      $res = mysqli_query($db,$sql) OR die(alert_php('error 1443'));
                      if(mysqli_num_rows($res) != 0)
                      {
                        while($row = mysqli_fetch_assoc($res))
                        {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="id_akun_aktiva">Akun Aktiva :</label>
                    <select id="id_akun_aktiva" name="id_akun_aktiva" class="form-control select2" style="width: 100%;" required>
                      <option value="">Pilih..</option>
                      <?php
                      $sql =
                      "SELECT
