...
if(isset($_GET['refresh']))
{
  ...
  unset($_SESSION['mata_uang'.$id_nav_detail]);
...
if(isset($_GET['pdf']))
{
  navigasi_ke('master-mata-uang-pdf.php');
}
if(isset($_GET['excel']))
{
  navigasi_ke('master-mata-uang-excel.php');
}
if(isset($_POST['tombol_tambah']))
{
  unset($_SESSION['tombol_filter_'.$id_nav_detail]);  
  $mata_uang = strtoupper(fch($_POST['mata_uang']));
  ...
  {
    navigasi_ke('?id_nav_detail='.$id_nav_detail.'&daftar&gagal_tambah='.$mata_uang);
  }
  else
  {
    $sql = 
    ...
    navigasi_ke('?id_nav_detail='.$id_nav_detail.'&daftar&sukses_tambah='.$mata_uang);
  }
}
if(isset($_POST['tombol_ubah']))
{
  ...
  if(mysqli_num_rows($res) != 0)
  {
    navigasi_ke('?id_nav_detail='.$id_nav_detail.'&page='.$page.'&daftar&id='.$id.'&gagal_ubah='.$mata_uang);
  }
  else
  {
    $sql =
    ...
    navigasi_ke('?id_nav_detail='.$id_nav_detail.'&page='.$page.'&daftar&id='.$id.'&sukses_ubah='.$mata_uang);
  }
}
if(isset($_POST['tombol_hapus']))
{
  ...
  navigasi_ke('?id_nav_detail='.$id_nav_detail.'&daftar&id='.$id.'&sukses_hapus='.$mata_uang);
}
?>
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar Mata Uang</h3>
            <div class="box-tools">
              <div class="btn-group">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-danger" style="padding:5px;">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              <div style="color:white;">Gagal Mengubah; Sudah Ada Data Dengan Mata Uang Yang Sama</div>
            </div>
            <?php
            }
              ...
              <table class="table">
                ...
                if(isset($_POST['tombol_filter']) OR isset($_SESSION['tombol_filter_'.$id_nav_detail]))
                {
                  if(isset($_POST['tombol_filter']))
                  {
                    ...
                    $_SESSION['mata_uang'.$id_nav_detail] = $_POST['mata_uang'];
                  ...
                  else if(isset($_SESSION['tombol_filter_'.$id_nav_detail]))
                  {
                    ...
                    $mata_uang = $_SESSION['mata_uang'.$id_nav_detail];
                ...
                $res = mysqli_query($db,$sql) OR die(alert_php('error 349'));
                $nomor = $mulai + 1;
                $sort_by = '';
                ...
                <thead>
                  <tr>
                    ...
                    <th>Mata Uang <a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='mata_uang' AND $_GET['order']=='desc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?id_nav_detail=<?php echo $id_nav_detail; ?>&page=<?php echo $page; ?>&daftar&sort_by=mata_uang&order=desc"><i class="fa fa-sort-up fa-lg"></i></a><a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='mata_uang' AND $_GET['order']=='asc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?id_nav_detail=<?php echo $id_nav_detail; ?>&page=<?php echo $page; ?>&daftar&sort_by=mata_uang&order=asc"><i class="fa fa-sort-down fa-lg"></i></a></th>
          ...
          <div class="box-footer">
            <?php echo showLog('tb_master_mata_uang'); ?>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Mata Uang</h3>
          </div>
...
//PAGE_UBAH
  if(isset($_GET['ubah']))
  {
    ...
    WHERE
      a.id = '".$id."'";
    $res = mysqli_query($db,$sql) OR die(alert_php('error 520'));
    if(mysqli_num_rows($res) != 0)
    {
      while($row = mysqli_fetch_assoc($res))
      {
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Ubah Mata Uang</h3>
          </div>
          <form role="form" method="POST">
            <div class="box-body">
              <div class="row">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Hapus Mata Uang</h3>
          </div>
          <form role="form" method="POST">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <label>Anda Yakin Ingin Menghapus : <b><u><?php echo $mata_uang; ?></u></b> ?</label>
                </div>
              </div>
              <br>
              <div class="row">
