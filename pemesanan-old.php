      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-xs-12" style="padding: 0 !important;">
            <table cellspacing="0" width="100%" style="margin: 0 !important;" border="0">
              <?php
              if($total == 0)
              {
              ?>
              <thead>
                <tr style="border-top:1px solid black;border-bottom:1px solid black;">
                  <td colspan="17" style="text-align:center;font-weight:bold;font-size:10pt;color:black;">Tidak Ada Data Ditemukan</td>
                </tr>
              </thead>
              <?php
              } 
              ...
              <thead>
                <tr style="border-bottom:1px solid black;">
                  <td style="text-align:left;font-weight:bold;font-size:10pt;color:black;padding-left:5px;">Tgl. <a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='tanggal' AND $_GET['order']=='desc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?daftar&sort_by=tanggal&order=desc"><i class="fa fa-sort-up fa-lg"></i></a><a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='tanggal' AND $_GET['order']=='asc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?daftar&sort_by=tanggal&order=asc"><i class="fa fa-sort-down fa-lg"></i></a></td>
                  <td style="text-align:left;font-weight:bold;font-size:10pt;color:black;padding-left:5px;">Nomor <a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='nomor' AND $_GET['order']=='desc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?daftar&sort_by=nomor&order=desc"><i class="fa fa-sort-up fa-lg"></i></a><a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='nomor' AND $_GET['order']=='asc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?daftar&sort_by=nomor&order=asc"><i class="fa fa-sort-down fa-lg"></i></a></td>
                  <td style="text-align:left;font-weight:bold;font-size:10pt;color:black;padding-left:5px;">Supplier <a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='pemasok' AND $_GET['order']=='desc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?daftar&sort_by=pemasok&order=desc"><i class="fa fa-sort-up fa-lg"></i></a><a <?php if(isset($_GET['sort_by']) AND $_GET['sort_by']=='pemasok' AND $_GET['order']=='asc') echo 'style="color:red;"'; else echo 'style="color:black;"';?> href="?daftar&sort_by=pemasok&order=asc"><i class="fa fa-sort-down fa-lg"></i></a></td>
                  <td style="text-align:left;font-weight:bold;font-size:10pt;color:black;padding-left:5px;">PPN (%)</td>
                  <td style="text-align:left;font-weight:bold;font-size:10pt;color:black;padding-left:5px;">M.U</td>
                  <td style="text-align:right;font-weight:bold;font-size:10pt;color:black;padding-right:5px;">Sub Total</td>
                  <td style="text-align:right;font-weight:bold;font-size:10pt;color:black;padding-right:5px;">Nilai PPN</td>
                  <td style="text-align:right;font-weight:bold;font-size:10pt;color:black;padding-right:5px;">Total</td>
                  <td style="text-align:right;font-weight:bold;font-size:10pt;color:black;padding-right:5px;">Kurs</td>
                  <td style="text-align:right;font-weight:bold;font-size:10pt;color:black;padding-right:5px;">Konversi (Rp)</td>
                  <td style="text-align:left;font-weight:bold;font-size:10pt;color:black;padding-left:5px;">Admin</td>
                  <td colspan="3" style="text-align:center;font-weight:bold;font-size:10pt;color:black;">#</td>
                </tr>
              </thead>
              <tbody>
                <?php     
                ...
                ?>
                <tr style="border-bottom:1px solid black;text-align:center;<?php if(isset($_GET['id']) AND $row['id'] == $_GET['id']) echo 'background-color:darkorange';?>">
                  <td style="padding:5px;text-align:left;width:1.5cm;"><?php echo date('d/m/y',strtotime($row['tanggal'])); ?></td>
                  <td style="padding:5px;text-align:left;width:2cm;"><?php echo $row['nomor']; ?></td>
                  <td style="padding:5px;text-align:left"><?php echo $row['pemasok']; ?></td>
                  <td style="padding-top:3px;padding-bottom:3px;text-align:center;width:1.5cm;"><?php echo $row['ppn'] * 100; ?></td>
                  <td style="padding-top:3px;padding-bottom:3px;text-align:center;width:1cm;"><?php echo $row['mata_uang']; ?></td>
                  <td style="padding:5px;text-align:right;width:2.2cm;"><?php echo number_format($row['sub_total'],2); ?></td>
                  <td style="padding:5px;text-align:right;width:2.2cm;"><?php echo number_format($row['sub_total'] * $row['ppn'],2); ?></td>
                  <td style="padding:5px;text-align:right;width:2.2cm;"><?php echo number_format($row['total'],2); ?></td>
                  <td style="padding:5px;text-align:right;width:2.2cm;"><?php echo number_format($row['nilai_tukar'],2); ?></td>
                  <td style="padding:5px;text-align:right;width:2.2cm;"><?php echo number_format($row['total'] * $row['nilai_tukar'],2); ?></td>
                  <td style="padding:5px;text-align:left;width:1cm;"><?php echo $row['nama']; ?></td>
                  <td style="padding-top:3px;padding-bottom:3px;text-align:center;width:0.7cm;"><a class="fa fa-print fa-lg" style="cursor: pointer;color:black;text-decoration: none;" href="pengembalian-per-barang-pdf.php?id=<?php echo $row['id']; ?>" target="_blank"></a></td>
                  <td style="padding-top:3px;padding-bottom:3px;text-align:center;width:0.7cm;"><a class="fa fa-list fa-lg" style="cursor: pointer;color:black;text-decoration: none;" href="?detail&id=<?php echo $row['id']; ?>"></a></td>
                  <?php
                  if($tahun_pemesanan == $tahun_now)
                  {
                  ?>
                  <td style="padding-top:3px;padding-bottom:3px;text-align:center;width:0.7cm;"><a class="fa fa-trash fa-lg" style="cursor: pointer;color:black;text-decoration: none;" href="?hapus&id=<?php echo $row['id']; ?>"></a></td>
                  <?php
                  }
                  else
                  {
                  ?>
                  <td style="padding-top:3px;padding-bottom:3px;text-align:center;width:0.7cm;"><a class="fa fa-trash fa-lg" style="cursor: pointer;color:black;text-decoration: none;" href="#"></a></td>
                  <?php
                  } 
                  ?>
                </tr>
                ...
                ?>
                <tr style="border-bottom:1px solid black;">
                  <td colspan="9" style="padding:5px;text-align:right;font-weight:bold;">Grand Total : </td>
                  <td style="padding:5px;text-align:right;font-weight:bold;"><?php echo number_format($total_konversi,2); ?></td>
                  <td colspan="4"></td>
                </tr>
              </tbody>
              <?php 
