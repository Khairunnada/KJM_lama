...
if(isset($_POST['tombol_tambah']))
{
  ...
  {
    navigasi_ke('?id_nav_detail='.$id_nav_detail.'&daftar&gagal_tambah='.$barang);
  }
  else
  {
    $sql = 
        ...
        <div class="box box-primary">
          ...
          <form role="form" method="POST">
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-2">
                  <button type="submit" name="tombo_ubah" class="btn btn-sm btn-flat btn-success"><i class="fa fa-sm fa-save"></i> Simpan</button>
