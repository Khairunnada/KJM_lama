...
if(isset($_POST['tombol_tambah']))
{
  ...
  $res = mysqli_query($db,$sql) OR die('error 36');
  ...
  mysqli_query($db,$sql) OR die('error 58');
  ...
  mysqli_query($db,$sql) OR die('error 73');
  navigasi_ke('?id_nav_detail='.$id_nav_detail.'&daftar&sukses_tambah');
}
if(isset($_POST['tombol_tambah_detail']))
{
  ...
  $sql .= " ORDER BY a.posisi DESC LIMIT 1";
  $res = mysqli_query($db,$sql) OR die('error 92');
  if(mysqli_num_rows($res) != 0)
  {
    while($row = mysqli_fetch_assoc($res))
    {
  ...
  mysqli_query($db,$sql) OR die('error 119');
  ...
  mysqli_query($db,$sql) OR die('error 134');
  navigasi_ke('?id_nav_detail='.$id_nav_detail.'&page='.$page.'&detail&id='.$id.'&sukses_tambah');
}
if(isset($_POST['tombol_ubah']))
{
  ...
  WHERE
    a.id = '".$id."'";
  mysqli_query($db,$sql) OR die('error 148');
  $sql =
  "INSERT INTO
    tb_log
  VALUES
  ...
  mysqli_query($db,$sql) OR die('error 162');
...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?id_nav_detail=<?php echo $id_nav_detail; ?>&refresh&daftar">Navigasi</a></li>
    </ol>
  </section>
  <?php
//PAGE_DAFTAR
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-success" style="padding:5px;">
              ...
              <div style="color:black;">Berhasil Menambah Navigasi Baru</div>
            </div>
            <?php
            }
            ...
            <div class="alert alert-success" style="padding:5px;">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              <div style="color:black;">Berhasil Mengubah Navigasi</div>
            </div>
            <?php
            }
            ...
            <div class="alert alert-success" style="padding:5px;">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              <div style="color:black;">Berhasil Menghapus Navigasi</div>
            </div>
            <?php
            }
            ?>
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" name="kode" id="kode" class="form-control" autocomplete="off" required>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" name="postfix" id="postfix" class="form-control" autocomplete="off" required>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Detail Navigasi</h3>
            <div class="box-tools">
              <div class="box-tools">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-default btn-flat">File</button>
        ...
        <div class="box box-primary">
          ...
          <form role="form" method="POST">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <label>Anda Yakin Ingin Menghapus Navigasi : <b><?php echo $nama; ?></b> ?</label>
                </div>
              </div>
              <div class="row">
                <div class="col-md-2">
